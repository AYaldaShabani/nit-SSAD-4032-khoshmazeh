...
import { uploadPost } from "./src/Core/Services/Api/uploadService.api";
...
export default function UploadPost() {
  ...
  const handleSubmit = async () => {
    ...
    if (result.success) alert("پست با موفقیت آپلود شد!");
    else alert("خطا در آپلود پست");
  };
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-col sm:flex-row gap-2 items-stretch sm:items-center">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1 text-white px-4 py-2 rounded whitespace-nowrap bg-[#D08C4F]"
          >
            <img src="./src/assets/icons8-plus 1.png" alt="اضافه کردن" />
          </button>
        </div>
