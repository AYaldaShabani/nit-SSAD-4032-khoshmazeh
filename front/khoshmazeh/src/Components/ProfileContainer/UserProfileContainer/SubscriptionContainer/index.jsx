...
import { getPlans, subscribeToPlan } from "./src/Core/Services/Api/subscriptionService.api";
...
const SubscriptionPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert("پلن با موفقیت انتخاب شد!");
    } catch {
      alert("خطا در ارسال پلن (بک‌اند در دسترس نیست)");
    }
  };
      ...
      <div className="w-full max-w-md space-y-6">
          ...
          {plans.map((plan) => (
            ...
            >
              <div>
                ...
                <div className="text-[#D08C4F] font-semibold mt-2">
        ...
        <button
          ...
          className={`w-full py-3 rounded-xl font-bold transition ${
            selectedPlanId
              ? "bg-[#D08C4F] text-white hover:bg-[#b45e00]"
